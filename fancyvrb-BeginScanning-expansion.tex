...
% expand \FancyVerbGetLine, #1 = "first"
...
\ifx\FancyVerbStartString\relax%  true
  \ifnum\FancyVerbStartNum<\tw@%  true, 0.0pt < 2
    \FV@DefineFindStop
  \else
    \let\FV@FindStartStop\FV@FindStartNum
  \fi
...
% it is let to \FV@ListProcessLine@i in \FV@List, in \FV@VerbatimBegin, in \FVB@Verbatim
